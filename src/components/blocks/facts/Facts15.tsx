...
export default function Facts15() {
  return (
    <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-8 justify-content-center align-items-center">
      <div className="col-lg-4 text-center text-lg-start d-flex flex-column justify-content-center" data-cue="fadeIn">
      ...
      <div className="col-lg-8">
        <div className="row align-items-center counter-wrapper gy-6 text-center" data-cues="fadeIn">
