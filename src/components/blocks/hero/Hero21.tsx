    ...
    <section className="wrapper bg-light">
      <div className="container pt-10 pt-md-14 pb-14 pb-md-16 text-center">
        <div className="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 mb-14 align-items-center">
          ...
          <div className="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start">
            ...
            <p className="lead fs-lg mb-7">
              Empowering Futures with Expert Computer Training in Jaipur,Unlock
              your potential with industry-relevant computer courses, expert
              instructors, and flexible learning modes. Whether you're a
              student, job seeker, or professional, we help you build real-world
        ...
        <p className="text-center mb-8">
          Trusted by 10k+ students across India
        </p>
